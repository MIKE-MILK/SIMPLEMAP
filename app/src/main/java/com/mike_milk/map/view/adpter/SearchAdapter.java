package com.mike_milk.map.view.adpter;
...
public class SearchAdapter extends BaseAdapter {
    ...
    public SearchAdapter(Context context, List<Tip> tipList) {
        mContext = context;
        mListTips = tipList;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            if (view == null) {
                ...
                holder.mName = (TextView) view.findViewById(R.id.poi_field_id);
                holder.mAddress = (TextView) view.findViewById(R.id.poi_value_id);
                view.setTag(holder);
            } else {
